...
export const HomePage: React.FC = () => {
  ...
  return (
    <div style={{backgroundColor: '#FFFCEE', display: "flex", flexDirection: "column", paddingTop:140}}>
      ...
      <div style={{
        backgroundColor: "#386050", paddingTop:35, marginTop:140, paddingBottom:30, borderRadius: 35, display: "flex",
        flexDirection: "column", justifyContent: "center", alignItems: "center"
      }}>
        <h2 style={{ color: "#D9EFDE", fontSize: 28, textAlign: "center" }}>
          “Juntos, podemos reduzir a poluição do ar e manter as pessoas e o planeta saudáveis ​​e seguros.” - ONU
        </h2>
        <img className="imageMainPage" alt="Image Page" src={imagePage} />
      </div>

      <div style={{
        flexDirection: "column", justifyContent: "center", alignItems: "center", display: "flex", paddingTop:150, 
      ...
      <div
        style={{
          backgroundColor: '#fffcee', paddingTop: 120
        }}>
          ...
          {apiData?.length
            ? apiData?.map((component: any) => (
                <div key={component.name}>
                  ...
                  />
                  <p style={{color: 'black', fontWeight: 'bold', fontSize: 18, textAlign:"center"}}>{component.percentage}%</p>
                </div>
              ))
            : null}
        </div>
      ...
      <div style={{
        flexDirection: "column", justifyContent: "center", alignItems: "center", display: "flex", paddingTop: 130, 
        backgroundColor: "#FFFCEE" 
      }}> 
      ...
      <div style={{display:"flex", flexDirection:"column", justifyContent:"center", 
        textAlign:"center", color: '#FFFCEE', position: "relative"
      }}>
      <img className="tree" alt="tree" src={tree}/>
      <p className="treeText">
      "A natureza saudável é um direito<br/>humano. Hoje, a poluição do ar<br/>nega a milhares de milhões de<br/>pessoas os seus direitos.<br/>O ar poluído afeta 99% das<br/> pessoas no planeta"<br/>- Organização das Nações Unidas (ONU)
      </p>
      </div>
